...
namespace RealGasStation.CustomAI
{
    public class CustomPassengerCarAI : PassengerCarAI
    {
        public void PassengerCarAIArriveAtTargetForRealGasStationPre(ushort vehicleID, ref Vehicle data)
        {
            ...
            {
                Singleton<EconomyManager>.instance.AddResource(EconomyManager.Resource.PublicIncome, 3000 * RealGasStationThreading.reduceCargoDiv, ItemClass.Service.Vehicles, ItemClass.SubService.None, ItemClass.Level.Level1);
            }
        }
